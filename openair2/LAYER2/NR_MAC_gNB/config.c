...
static void config_common(gNB_MAC_INST *nrmac, rrc_pdsch_AntennaPorts_t pdsch_AntennaPorts, int pusch_AntennaPorts, NR_ServingCellConfigCommon_t *scc)
{
                       ...
                       NR_ServingCellConfigCommon_t *scc)
{
  ...
  config_common(nrmac, pdsch_AntennaPorts, pusch_AntennaPorts, scc);
