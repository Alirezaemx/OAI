...
#    define LOG_P(lvl, _string, buf, len)
#    define LOG_MAC_P(lvl, _string, sfn, sf, mac_pack_info, buf, len)
#    define LOG_RLC_P(lvl, _string, sfn, sf, rlc_pack_info, buf, len)
#    define LOG_PDCP_P(lvl, _string, sfn, sf, pdcp_pack_info, buf, len)
#    define LOG_LTE_PDCP_PDU(lvl, _string, sfn, sf, pdcp_pack_info, buf, len)
#    define LOG_LTE_RLC_P(lvl, _string, sfn, sf, rlc_pack_info, buf, len)
